...
export function BlogspotPostPage() {
  const { slug } = useParams<{ slug: string }>();
  const { posts, isLoading } = useBlogspot();
    ...
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12 pb-2">
        ...
        <div className="flex items-center gap-4 py-6 border-t border-b border-gray-100 mb-10">
          <img
            src={omegaPhoto}
            alt="Omega Bone"
            className="w-12 h-12 rounded-full object-cover shrink-0 ring-2 ring-[#1a56db] ring-offset-2"
          />
          <div>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-10 p-6 bg-gray-50 rounded-2xl">
            ...
            <div>
              ...
              <p className="text-gray-600 text-center sm:text-left" style={{ lineHeight: 1.75, fontSize: "0.95rem" }}>
                Omega Bone is a music educator, performer, and vocal coach with over 25 years of experience. She has taught non-native English speakers across international schools in Germany, South Korea, Japan, and the United States. As a performer, she has shared the stage with Michael Jackson, Stevie Wonder, and Prince, and lent her voice to commercial campaigns for McDonald's, Häagen-Dazs, and Mercedes-Benz, among many others.
              </p>
            </div>
          </div>
      ...
      <section className="py-16" style={{ backgroundColor: accent }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="mb-8" style={{ lineHeight: 1.7, color: "#d4c6eb" }}>
            Reading about vocal technique is the first step. The transformation happens in the work.
          </p>
          <a
            href="/#get-started"
            className="inline-flex items-center gap-2 bg-white px-8 py-4 rounded-full hover:bg-purple-50 transition-all hover:shadow-xl group"
