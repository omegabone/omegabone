...
export function Music33BlogPostPage() {
  const { slug } = useParams<{ slug: string }>();
  const { posts, isLoading } = useBlogspotFeed("https://musicroom33.blogspot.com");
    ...
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section className="py-16" style={{ backgroundColor: accent }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="mb-8" style={{ lineHeight: 1.7, color: "#bfdbfe" }}>
