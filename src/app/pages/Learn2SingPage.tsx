    ...
    <section id="blog" className="py-24 bg-[#f0fdf4]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          ...
          <a href="/vocal-mastery/blog" className="flex items-center gap-2 text-[#166534] hover:text-[#14532d] transition-colors whitespace-nowrap" style={{ fontWeight: 700 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {isLoading ? (
            ...
            posts.map((post) => (
            <a key={post.slug} href={`/vocal-mastery/blog/${post.slug}`} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group flex flex-col">
              {post.image && (
