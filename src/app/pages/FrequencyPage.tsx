    ...
    <div className="freq-root" ref={rootRef}>
          ...
          <div className="proof-videos">
            ...
            <div className="proof-video-item">
              <div className="videoframe" data-name="Irina Sergeeva">
                <iframe
                  src="https://www.youtube-nocookie.com/embed/7F9h-MDxm-E"
                  title="Irina Sergeeva, video testimonial"
                  loading="lazy"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  style={{ width: "100%", height: "100%", border: 0, display: "block" }}
        ...
        <div className="wrap">
          ...
          <div className="tiers">
            <div className="tier">
              ...
              <div className="tier-cta"><PayPalBookButton hostedButtonId="YQ8CNK2ACJ26U" /></div>
            </div>
            ...
            <div className="tier">
              ...
              <div className="tier-cta"><a className="btn-ghost" href="https://forms.gle/s94aL21E5iStdGoF6" target="_blank" rel="noopener noreferrer">Request an application</a></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="books" className="band-dark fade">
        <div className="wrap">
          ...
          <h2 className="centered" style={{ marginTop: 16, maxWidth: "24ch", marginLeft: "auto", marginRight: "auto" }}>Start with the book built for you.</h2>
          <p className="subline centered" style={{ margin: "16px auto 0", maxWidth: "50ch" }}>Each purchase unlocks that book, plus the first free lesson from The Frequency Series.</p>
