        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-24 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#166534] hover:bg-[#145228] text-white px-5 py-2.5 rounded-full text-sm transition-colors"
              style={{ fontWeight: 700 }}
            >
              Work with Omega
            </a>
          ...
          <div className="md:hidden bg-white border-t border-gray-100 px-6 py-5 space-y-4 shadow-lg">
            {navLinks.map((link) => (
              <a
                ...
                className="block text-sm text-gray-700 hover:text-[#166534] transition-colors"
                style={{ fontWeight: 600 }}
              >
                {link.label}
              </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block bg-[#166534] text-white text-center px-5 py-3 rounded-full text-sm"
              style={{ fontWeight: 700 }}
            >
              Work with Omega
            </a>
